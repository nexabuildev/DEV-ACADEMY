  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-6">
      <header className="mb-12">
        ...
        <p className="text-zinc-400 mt-2">Continúa donde lo dejaste y domina el código.</p>
      </header>

      {/* Grid de Cursos del Alumno */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {coursesWithProgress.map((course) => (
          <div key={course.id} className="bg-zinc-900/40 border border-zinc-800 rounded-3xl p-6 flex flex-col hover:border-blue-500/30 transition-all group">
            ...
            <div className="mt-auto">
              ...
              <Link 
                ...
                className="w-full bg-white text-black text-center py-3 rounded-xl font-bold hover:bg-zinc-200 transition-all block mt-4"
              >
        ...
        {coursesWithProgress.length === 0 && (
          <div className="col-span-full py-20 text-center bg-zinc-900/20 border-2 border-dashed border-zinc-800 rounded-3xl">
            ...
            <Link href="/cursos" className="bg-blue-600 text-white px-8 py-3 rounded-xl font-bold">
              Explorar Catálogo
            </Link>
          </div>
        )}
